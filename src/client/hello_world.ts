...
export async function establishConnection(): Promise<void> {
  ...
  /* Get the connection object and retrieve the version from the connection object. */
...
export async function checkProgram(): Promise<void> {
  ...
  greetedPubkey = await PublicKey.createWithSeed(
    payer.publicKey,
    GREETING_SEED,  //seed is hello, get same account everytime
    programId,  //owner of account, can write data
  );
